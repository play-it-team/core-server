    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', common.fields.TimeZoneField(blank=True, choices=[('Africa/Abidjan', 'Africa/Abidjan'),
                                                                              ...
                                                                              ('W-SU', 'W-SU'), ('WET', 'WET'),
                                                                              ('Zulu', 'Zulu')], default='',
                                                         max_length=100, verbose_name='Timezone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(default=django.utils.timezone.now)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_history',
                                           to='account.Account')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='password_expiry',
                                      to='account.Account', verbose_name='user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_address',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.EmailAddress')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('primary', models.BooleanField(default=False, verbose_name='Primary')),
                ('avatar', account.fields.AvatarField()),
                ('uploaded_on', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Uploaded on')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avatar',
                                              to='account.Account', verbose_name='Account')),
            ],
            options={
                'verbose_name': 'Avatar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_requested',
                 models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date Requested')),
